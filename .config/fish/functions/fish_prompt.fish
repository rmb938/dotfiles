# Copied and modified from ~/.local/share/omf/themes/default/fish_prompt.fish
# Modified to fix success color and to not show git status if root is homedir
